                    ...
                    <div class="ht__product__dtl">
                        ...
                        <div class="ht__pro__desc">
                            ...
                            <div class="sin__desc">
                                ...
                                ?>
                                <p><span>Availablity:</span> <?php echo $stock ?></p>
                            </div>
                            <div class="sin__desc">
                            <?php 
                            if($cart_show!=''){ ?>
                            ...
                            <?php 
                            if($cart_show!=''){ ?>
                            <a class="fr__btn" style="margin-top:40px" href="javascript:void(0)" onclick="manage_cart('<?php echo $get_product['0']['id'] ?>','add')">Add to Cart</a>
