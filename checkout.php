                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <form id="login-form"  method="post">
                                                            ...
                                                            <div class="form-output register_msg">
                                                                <p class="form-messege field_error sp_03"></p>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="accordion__body">
                                        <div class="bilinfo">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="single-input">
                                                            <input type="text" name="zipcode" placeholder="Post code/ zip" required>
                                                        </div>
                                                    </div>                                                 
                                                </div>
                        ...
                        <div class="order-details">
                            ...
                            <div class="order-details__item">
                                ...
                                <div class="single-item">
                                    ...
                                    <a href="javascript:void(0)" onclick="manage_cart('<?php echo $key?>','remove')"><i class="icon-trash icons"></i></a>                                    </div>
                                </div>
                                        <?php } ?>
                            </div>
