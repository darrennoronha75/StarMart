                                ...
                                <div class="wishlist-table table-responsive">
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            $res = mysqli_query($con,"select `order`.*,order_status.status as order_status_str from `order`,order_status where `order`.user_id='$uid' and order_status.id=`order`.order_status"); 
