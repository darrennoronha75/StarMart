...
function user_register(){
    ...
    if(email==""){ 
        jQuery("#email_error").html('Please enter your EmailID');
        iserror="yes";
    }
    if(mobile==""){
        jQuery("mobile_error").html('Please enter your Mobile No.') 
        iserror="yes";
    }
    if(password==""){
        jQuery("#password_error").html('Please enter a suitable password') 
        iserror="yes";
    }
    ...
    if(iserror==""){
        jQuery.ajax({
            ...
            success: function(result){
                ...
                if(result=='insert'){
                    jQuery('.sp_02').html('Successfully registered!');
                }
            }
        });
    }
    ...
    function user_login(){
        ...
        if(email==""){ 
            jQuery("#email_login_error").html('Please enter EmailID');
            iserror="yes";
        }
    
        if(password==""){
            jQuery("#password_login_error").html('Please enter the correct password') 
            iserror="yes";
        }
        ...
        if(iserror==""){
            jQuery.ajax({
                ...
                success: function(result){
                    if(result=='wrong'){
                       jQuery('.sp_03').html('Please enter valid login details');
...
function manage_cart(pid,type){
    ...
    // For Update Value, setting the type (qty)
